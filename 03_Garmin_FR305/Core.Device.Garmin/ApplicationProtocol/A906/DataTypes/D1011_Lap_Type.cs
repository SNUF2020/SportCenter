...
namespace SC._03_Garmin_FR305.Core.Device.Garmin.ApplicationProtocol.A906.DataTypes
{
    ...
    public struct D1011_Lap_Type : IA906
    {
        ...
        /// <summary>
        /// Constructor to create a D1011 type from its byte array representative.
        /// </summary>
        ...
        public D1011_Lap_Type(byte[] data)
        {
            ...
            if (data.Length < typeSizeWithoutUnknownBytes)
                throw new ArgumentException("TODO: (must localize) D1011_Lap_Type. length of data cannot be less than size of data structure");
